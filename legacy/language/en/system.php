...
$lang['sys_cookie_problem'] = 'There is a problem with your cookies. Try to <a href="login.php">log in</a> again and if the problem persists, contact the administrator';
...
$lang['sys_acc_deletion_text'] = "You are in account deletion mode. Your account will be removed on %s unless you change the decision in options.";
