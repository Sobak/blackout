...
<tr>
    ...
    <td><div><a href="userlist.php" accesskey="a">{adm_plrlst}</a></div></td>
</tr><tr>
    <td><div><a href="paneladmina.php" accesskey="k">{adm_plrsch}</a></div></td>
</tr><tr>
    <td><div><a href="add_money.php" accesskey="k">{adm_addres}</a></div></td>
</tr><tr>
    <td><div><a href="del_money.php" accesskey="k">{adm_delres}</a></div></td>
</tr><tr>
    <td style="background-color:#FFFFFF" height="1px"></td>
</tr><tr>
    <td><div><a href="planetlist.php" accesskey="1">{adm_pltlst}</a></div></td>
</tr><tr>
    <td><div><a href="activeplanet.php" accesskey="k">{adm_actplt}</a></div></td>
</tr><tr>
    <td style="background-color:#FFFFFF" height="1px"></td>
</tr><tr>
    <td><div><a href="moonlist.php" accesskey="k">{adm_moonlst}</a></div></td>
</tr><tr>
    <td><div><a href="add_moon.php" accesskey="k">{adm_addmoon}</a></div></td>
</tr><tr>
    <td style="background-color:#FFFFFF" height="1px"></td>
</tr><tr>
    ...
    <td><div><a href="unbanned.php" accesskey="k">{adm_unban}</a></div></td>
</tr><tr>
    <td background="{dpath}img/bg1.gif"><center>{tool}</center></td>
</tr><tr>
    <td><div><a href="statbuilder.php" accesskey="p">{adm_updpt}</a></div></td>
</tr><tr>
    <td><div><a href="messagelist.php" accesskey="k">{adm_msg}</a></div></td>
</tr><tr>
